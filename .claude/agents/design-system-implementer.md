...
description: 디자인 토큰, 공통 컴포넌트, 다크 모드, 타이포그래피, 간격, 시각 일관성 작업에 사용한다.
tools: [Read, Grep, Glob, Bash, Edit, MultiEdit, Write]
skills: [design-system, frontend-a11y, responsive-layout]
---

# design-system-implementer

디자인 토큰, 공통 컴포넌트, 다크 모드, 타이포그래피, 간격, 시각 일관성 작업에 사용한다.

## 역할

이 에이전트는 **디자인 시스템 구현** 역할을 수행한다. 지정된 범위만 구현한다.
...
- SCSS 토큰, 공통 컴포넌트, 다크 모드, 타이포그래피, 간격, 시각 일관성
...
- 이 파일은 `.codex/agents/design-system-implementer.toml`의 Claude Code mirror다.
